        ...
        <CardContent>
          <div className="grid gap-4 md:grid-cols-3">
            <div className="rounded-lg border border-gray-200 bg-white p-4">
              ...
              <div className="mt-2 text-2xl font-bold text-gray-900">3.2%</div>
            ...
            <div className="rounded-lg border border-gray-200 bg-white p-4">
              ...
              <div className="mt-2 text-2xl font-bold text-gray-900">$124.50</div>
              <div className="mt-1 text-xs text-green-600">
            ...
            <div className="rounded-lg border border-gray-200 bg-white p-4">
              ...
              <div className="mt-2 text-2xl font-bold text-gray-900">$1,245</div>
              <div className="mt-1 text-xs text-green-600">
                +$98 from last period
              </div>
            </div>
